...
public class GenerateMybatisPlus {
     ...
     */
    public void generate(String projectName,String projectPath,String author,String dataSourceurl, String dataSourcename, String dataSourcepassword, String dataSourcedriver, String tables, String packageParent, boolean isNormalize) {
...
//        gc.setXmlName("%sMapper");
        ...
        pc.setEntity("domain"); // 默认是entity
//        pc.setXml("mapping"); // 默认是默认是mapper.xml
        pc.setModuleName(projectName); // 控制层请求地址的包名显示
        ...
        strategy.setTablePrefix("t_"); // 去掉表名mdm_inf_rec_data中的 mdm_ 类名为InfRecData
        ...
        tc.setEntity("/templatesFreemaker/domain.java");
...
//        tc.setXml("/templatesFreemaker/mapper.xml");
        ...
        // 自定义配置会被优先输出1
        focList.add(new FileOutConfig("/templatesFreemaker/mapper.xml.ftl") {
            @Override
